...
{
    /// <summary>
    /// Contains the six characteristics that define a character in Traveller.
    /// </summary>
    /// <remarks>
    /// Characteristics values typically range from 1-15. An attribute of 0 or less generally means that the character is dead. Attributes over 15 should be
